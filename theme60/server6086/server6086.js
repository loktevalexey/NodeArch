...
// READ
webserver.get('/groups', async (req, res) => { 
...
// READ
webserver.get('/group/:groupname', async (req, res) => { 
...
// CREATE
webserver.post('/groups', async (req, res) => { 
...
// UPDATE
webserver.put('/groups', async (req, res) => { 
...
// DELETE
webserver.delete('/groups', async (req, res) => { 
