// чисто для примера - скрипт, выполняющий внутренний поиск по фразе "неделя Минск" и выводящий результаты в консоль
// вообще же, подобный код нужно выполнять при обработке запроса на внутренний поиск от клиента и результаты выводить на страницу
...
(async function() {
    ...
    */
    ...
    // чем делать отдельный запрос ради каждого index_url, 
