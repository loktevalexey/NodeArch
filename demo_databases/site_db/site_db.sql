...
CREATE TABLE `options` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'идентификатор',
  `code` varchar(20) NOT NULL DEFAULT '' COMMENT 'код настройки',
  `comment` varchar(200) NOT NULL DEFAULT '' COMMENT 'комментарий',
  `str_value` varchar(250) DEFAULT NULL COMMENT 'значение настройки, если оно строковое',
  ...
  `text_value` mediumtext COMMENT 'значение настройки, если оно длинное текстовое',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='настройки';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `options` VALUES (15,'SR','ставка рефинансирования',NULL,NULL,8.5,NULL,NULL),(16,'SRD','дата последнего изменения ставки рефинансирования',NULL,NULL,NULL,'2019-12-01 00:00:00',NULL),(17,'SITENAME','название сайта','Свежие новости и погода',NULL,NULL,NULL,NULL);
...
-- Dump completed on 2020-01-10 13:41:45
