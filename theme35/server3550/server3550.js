...
const upload = multer( { dest: path.join(__dirname,"uploads") } ); // миддлварь для работы с multipart/form-data; если потребуется сохранение загруженных файлов - то в папку uploads
...
webserver.post('/service4', service4files, (req, res) => { // миддлварь, сохраняющая файл, прилетевший под именем photo
